...
export const signupUser = (firstname: string, lastname: string, email: string, password: string, telephone: string, addresse: string): AuthActionType => ({
    type: AuthActionTypes.SIGNUP_USER,
    payload: { firstname, lastname, email, password, telephone, addresse },
});
