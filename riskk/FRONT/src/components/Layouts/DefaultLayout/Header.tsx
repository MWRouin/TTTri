...
const Header = () => {
    ...
    const handleIconHeartClick = () => {
        navigate('/favouritelist'); // Navigate to the favourite list page
    };
    ...
    return (
        <header className={`z-40 ${themeConfig.semidark && themeConfig.menu === 'horizontal' ? 'dark' : ''}`}>
                ...
                <div className="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-black">
                    <div className="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                        <Link to="/home" className="main-logo flex items-center shrink-0">
                            ...
                            <span className="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle hidden md:inline dark:text-white-light transition-all duration-300">TRI_TRAINING</span>
                        </Link>
                        <button
                            type="button"
            ...
            >
                            ...
                            >
                                <ul className="bg-white shadow-lg rounded-lg w-[230px] font-semibold text-black">
                                    <li className="flex items-center px-4 py-4 border-b">
                                        <img className="rounded-full w-10 h-10 object-cover" src="/assets/images/user-profile.jpeg" alt="userProfile" />
                                    ...
                                    <li className="hover:bg-gray-100">
                                        <Link to="/notifications" className="flex items-center px-4 py-3">
                                            <span className="text-sm">Notifications</span>
                                        </Link>
                                    </li>
                                    <li className="hover:bg-gray-100">
                                        <Link to="/messages" className="flex items-center px-4 py-3">
                                            <span className="text-sm">Messages</span>
                                        </Link>
                                    </li>
                                    <li className="border-t border-gray-200 hover:bg-gray-100">
                                        <Link to={`/users/user-account-settings/${userConnected.firstname}`} className="flex items-center px-4 py-3">
                ...
                {/* horizontal menu */}
                <ul className="horizontal-menu hidden  font-semibold px-6 lg:space-x-1.5 xl:space-x-8 rtl:space-x-reverse bg-white border-t border-[#ebedf2] dark:border-[#191e3a] dark:bg-black text-black dark:text-white-dark">
