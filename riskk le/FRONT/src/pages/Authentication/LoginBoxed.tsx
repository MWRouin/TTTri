                ...
                >
                    <div className="mx-auto w-full max-w-[400px]">
                        <div className="mb-5">
                            ...
                            <p className="text-base font-bold leading-normal text-dark mt-6">Entrez votre email et mot de passe pour vous connecter</p>
                        </div>
                        ...
                        <div className="text-center dark:text-white">
                            ...
                            <Link to="/auth/boxed-signup" className="text-md text-danger hover:text-gray-800">
                                S'INSCRIRE
                            </Link>
                        </div>
                    </div>
