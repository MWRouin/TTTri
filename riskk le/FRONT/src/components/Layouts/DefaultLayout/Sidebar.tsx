...
const Sidebar = () => {
  ...
  const [currentMenuCertif, setCurrentMenuCertif] = useState<string>('');
  ...
  const toggleMenuCertif = (value: string) => {
    setCurrentMenuCertif((oldValue) => {
      return oldValue === value ? '' : value;
    });
  };
        ...
        <div className="bg-white dark:bg-black h-full">
          <div className="flex justify-between items-center px-4 py-3">
            <NavLink to="/home" className="main-logo flex items-center shrink-0">
              <img className="w-40 ml-[15px] mt-[-10px] flex-none" src="/assets/images/logotrit.png" alt="logo" />
            </NavLink>
          ...
          <PerfectScrollbar className="h-[calc(100vh-80px)] relative">
            <ul className="relative font-semibold space-y-0.5 p-4 py-0">
              ...
              <li className="nav-item">
                <NavLink to="/ajoutcours" className="group">
                  <div className="flex items-center">
                    <IconMenuContacts className="group-hover:!text-primary shrink-0" />
                    <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('AjoutCours')}</span>
                  </div>
                </NavLink>
              </li>
              <li className="nav-item">
              ...
              <li className="nav-item">
                <NavLink to="/gestionutlilisateurs" className="group">
                  <div className="flex items-center">
                    <IconMenuContacts className="group-hover:!text-primary shrink-0" />
                    <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Gestion Utlilisateurs')}</span>
                  </div>
                </NavLink>
              </li>

              <li className="nav-item">
                <NavLink to="/gestioncategories" className="group">
                  <div className="flex items-center">
                    <IconMenuContacts className="group-hover:!text-primary shrink-0" />
                    <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Gestion Categories')}</span>
                  </div>
                </NavLink>
              </li>
              <li>
              <button type="button" className={`${currentMenuCertif === 'Gestion certif' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenuCertif('Gestion certif')}>
                  <div className="flex items-center  justify-between">
                    ...
                    <div className={currentMenuCertif !== 'Gestion certif' ? 'rtl:rotate-90 -rotate-90' : ''}>
                    <IconCaretDown />
                  </div>
                  </div>
              ...
              <AnimateHeight duration={300} height={currentMenuCertif === 'Gestion certif' ? 'auto' : 0}>
                  <ul className="sub-menu text-gray-500">
                    <li>
                      <NavLink to="/CreateCertif">{t('Create Certificate')}</NavLink>
                      <NavLink to="/PrintCertif">{t('Print Certificate')}</NavLink>
                    </li>
