...
import HomeHeaderLanding from '../LandingLayout/HomeHeaderLanding';
    ...
    return (
        <>
            ...
            <div className="relative">
                ...
                <div className="fixed bottom-6 ltr:right-6 rtl:left-6 z-50">{'claim'}</div>
                ...
                <div className={`${themeConfig.navbar} main-container text-black dark:text-white-dark min-h-screen`}>
                    ...
                    <div className="main-content flex w-full flex-col min-h-screen">
                        {/* BEGIN TOP NAVBAR */}
                        <HomeHeaderLanding />
                        {/* END TOP NAVBAR */}
