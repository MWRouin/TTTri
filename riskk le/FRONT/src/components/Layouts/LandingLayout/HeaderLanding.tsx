        ...
        <>
            <>
                <header className={`z-40   sticky top-0  ${themeConfig.semidark && themeConfig.menu === 'horizontal' ? 'dark' : ''}`}>
                    <div className={`shadow-sm dark:bg-black bg-white  `}>
                        <div className={`relative  flex w-full items-center px-5 py-2.5  dark:bg-black bg-white `}>
                            <div className="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                                <Link to="/home" className="main-logo flex items-center shrink-0">
                                    ...
                                    <span className="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle hidden md:inline  dark:text-white-light ">TRI_TRAINING</span>
                                </Link>
                                <button
                                    type="button"
                            ...
                            <div className="sm:flex-1 ltr:sm:ml-0 ltr:ml-auto sm:rtl:mr-0 rtl:mr-auto flex items-center space-x-1.5 lg:space-x-2 rtl:space-x-reverse dark:text-[#d0d2d6]">
                                ...
                                <div className="dropdown shrink-0 flex">
                                    <Dropdown
                                        ...
                                        trigger="hover" // Change to hover trigger
                                        button={
                                    ...
                                    >
                                        <ul className="text-dark dark:text-white-dark !py-0 w-[230px] font-semibold dark:text-white-light/90">
                                            <li>
                                                <div className="flex items-center px-4 py-4">
                                                    ...
                                                    <div className="ltr:pl-4 rtl:pr-4 truncate">
                                                        <h4 className="text-base">{userConnected?.firstname}</h4>
                                            ...
                                            <li>
                                                <Link to="/users/profile" className="dark:hover:text-white flex items-center px-4 py-2">
                                            ...
                                            <li className="border-t border-white-light dark:border-white-light/10">
                                                <Link to="/auth/boxed-signin" className="text-danger !py-3 flex items-center px-4">
             ...
             text-black dark:text-white-light
              ...
              `}
                        >
                            ...
                            <li className="menu nav-item relative">
                                <button type="button" id="acceuil" className="nav-link">
                                    <div className="flex items-center">
                                        <div className="flex items-center">
                                            <IconMenuDashboard className="shrink-0  " />
                                            <span className="px-1 ">{t('Acceuil')}</span>
                                        </div>
